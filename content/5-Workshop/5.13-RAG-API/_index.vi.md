...
Lambda RAG API (Python 3.11, 30s timeout, 1024 MB)
       ...
       │
       ▼
Client (JSON response với answer + sources)
```
...
def retrieve(query: str, top_k: int = 5) -> List[dict]:
    """
    Embed query với Bedrock, search pgvector cho similar chunks.
    ...
    try:
        with conn.cursor() as cur:
            # Set HNSW ef_search cho better recall (default 40)
...
**Tiếp theo:** [Frontend Integration (Next.js + FastAPI)](5.14-Frontend/)