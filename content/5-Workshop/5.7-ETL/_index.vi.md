...
def run_etl_warehouse(limit: Optional[int] = None) -> int:
    """Entry point cho main.py --mode etl"""
...
```bash
# Sau khi crawler + consumer đã populate article_metadata
...
For AWS, ETL runs as **Lambda function** triggered by EventBridge (02:00 UTC), using **Bedrock Titan Embed v2** for embeddings directly in the same function. See [Lambda ETL + Embedding](5.12-Lambda-ETL/).
...
**Tiếp theo:** [Vector hóa](5.8-Vectorize/)